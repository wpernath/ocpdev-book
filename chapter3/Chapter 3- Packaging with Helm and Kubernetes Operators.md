...
Unofficially (not supported right now), you can also implement the Operator's logic in other programming languages, such as [Java via a Quarkus extension][25].
